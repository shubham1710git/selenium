...
public interface Constants {
    ...
    String CONFIG_FIRSTNAME= Utilities.getValueFromPropertiesFile(TEST_DATA_FILE, "firstname");
    String CONFIG_LASTNAME= Utilities.getValueFromPropertiesFile(TEST_DATA_FILE, "lastname");
